			...
			<div class="row merged20" id="page-contents">
					...
					<aside class="sidebar">
						<div class="central-meta stick-widget">
							...
							<div class="personal-head">
								<span class="f-title"><i class="fa fa-user"></i> About
									Me:</span>
								<p>Hi, I’m John Carter, I’m 36 and I work as a Digital
									Designer for the “dewwater” Agency in Ontario, Canada</p>
								<span class="f-title"><i class="fa fa-birthday-cake"></i>
									Birthday:</span>
								<p>December 17, 1985</p>
								<span class="f-title"><i class="fa fa-phone"></i> Phone
									Number:</span>
								<p>+1-989-232435234</p>
								<span class="f-title"><i class="fa fa-medkit"></i> Blood
									group:</span>
								<p>B+</p>
								<span class="f-title"><i class="fa fa-male"></i> Gender:</span>
								<p>${USER.gender }</p>
								<span class="f-title"><i class="fa fa-globe"></i>
									Country:</span>
								...
								<span class="f-title"><i class="fa fa-envelope"></i>
									Email & Website:</span>
								<p>
									<a href="wpkixx" title="">www.wpkixx.com</a> <a
				...
				<div class="col-lg-8 col-md-8">
					<div class="central-meta">
						<span class="create-post">General Info<a href="#" title="">See
								All</a></span>
						<div class="row">
							<div class="col-lg-6">
								<div class="gen-metabox">
									<span><i class="fa fa-puzzle-piece"></i> Hobbies</span>
									<p>I like to ride the bicycle, swimming, and working out. I
										also like reading design magazines, and searching on internet,
										and also binge watching a good hollywood Movies while it’s
										raining outside.</p>
								</div>
								<div class="gen-metabox">
									<span><i class="fa fa-plus"></i> Others Interests</span>
									<p>Swimming, Surfing, Uber Diving, Anime, Photography,
										Tattoos, Street Art.</p>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="gen-metabox">
								...
								<div class="gen-metabox">
									...
									<p>
										...
										from the last 5 five years as <a href="#" title="">Senior
											UI/UX Designer</a>
									</p>
								</div>
							</div>
							...
							<div class="col-lg-6">
								<div class="gen-metabox no-margin">
									...
									<ul class="badged">
										<li><img
											src="<c:url value="/layouts/web/images/badges/badge2.png" />"
											alt=""></li>
										<li><img
											src="<c:url value="/layouts/web/images/badges/badge19.png" />"
											alt=""></li>
										<li><img
											src="<c:url value="/layouts/web/images/badges/badge21.png" />"
											alt=""></li>
										<li><img
											src="<c:url value="/layouts/web/images/badges/badge3.png" />"
											alt=""></li>
										<li><img
											src="<c:url value="/layouts/web/images/badges/badge4.png" />"
											alt=""></li>
									</ul>
								</div>
							</div>
					...
					<div class="central-meta">
						<span class="create-post">Favourit Movies & TV Shows (33) <a
							href="#" title="">See All</a></span>
						<div class="row">
							<div class="col-lg-4 col-md-6 col-sm-6">
								<div class="fav-play">
									<figure>
										<img
											src="<c:url value="/layouts/web/images/resources/tvplay1.jpg" />"
											alt="">
									</figure>
							...
							<div class="col-lg-4 col-md-6 col-sm-6">
								<div class="fav-play">
									<figure>
										<img
											src="<c:url value="/layouts/web/images/resources/tvplay2.jpg" />"
											alt="">
									</figure>
							...
							<div class="col-lg-4 col-md-6 col-sm-6">
								<div class="fav-play">
									<figure>
										<img
											src="<c:url value="/layouts/web/images/resources/tvplay3.jpg" />"
											alt="">
									</figure>
					...
					<div class="central-meta">
						<span class="create-post">Friend's (320) <a
							href="timeline-friends" title="">See All</a></span>
						<ul class="frndz-list">
							<li><img
					...
					<!-- friends list -->
					<div class="central-meta">
						<span class="create-post">Photos (580) <a
							href="timeline-photos" title="">See All</a></span>
						<ul class="photos-list">
							<li>
								<div class="item-box">
									<a class="strip"
										href="<c:url value="/layouts/web/images/resources/photo-22.jpg" />"
										title="" data-strip-group="mygroup"
										data-strip-group-options="loop: false"> <img
										src="<c:url value="/layouts/web/images/resources/photo2.jpg" />"
										alt=""></a>
							...
							<li>
								<div class="item-box">
									<a class="strip"
										href="<c:url value="/layouts/web/images/resources/photo-33.jpg" />"
										title="" data-strip-group="mygroup"
										data-strip-group-options="loop: false"> <img
										src="<c:url value="/layouts/web/images/resources/photo3.jpg" />"
										alt=""></a>
									<div class="over-photo">
										<div class="likes heart" title="Like/Dislike">
											❤ <span>20</span>
							...
							<li>
								<div class="item-box">
									<a class="strip"
										href="<c:url value="/layouts/web/images/resources/photo-44.jpg" />"
										title="" data-strip-group="mygroup"
										data-strip-group-options="loop: false"> <img
										src="<c:url value="/layouts/web/images/resources/photo4.jpg" />"
										alt=""></a>
									<div class="over-photo">
										<div class="likes heart" title="Like/Dislike">
											❤ <span>155</span>
							...
							<li>
								<div class="item-box">
									<a class="strip"
										href="<c:url value="/layouts/web/images/resources/photo-55.jpg" />"
										title="" data-strip-group="mygroup"
										data-strip-group-options="loop: false"> <img
										src="<c:url value="/layouts/web/images/resources/photo5.jpg" />"
										alt=""></a>
									<div class="over-photo">
										<div class="likes heart" title="Like/Dislike">
											❤ <span>201</span>
							...
							<li>
								<div class="item-box">
									<a class="strip"
										href="<c:url value="/layouts/web/images/resources/photo-66.jpg" />"
										title="" data-strip-group="mygroup"
										data-strip-group-options="loop: false"> <img
										src="<c:url value="/layouts/web/images/resources/photo6.jpg" />"
										alt=""></a>
									<div class="over-photo">
										<div class="likes heart" title="Like/Dislike">
											❤ <span>81</span>
							...
							<li>
								<div class="item-box">
									<a class="strip"
										href="<c:url value="/layouts/web/images/resources/photo-77.jpg" />"
										title="" data-strip-group="mygroup"
										data-strip-group-options="loop: false"> <img
										src="<c:url value="/layouts/web/images/resources/photo7.jpg" />"
										alt=""></a>
									<div class="over-photo">
										<div class="likes heart" title="Like/Dislike">
											❤ <span>98</span>
							...
							<li>
								<div class="item-box">
									<a class="strip"
										href="<c:url value="/layouts/web/images/images/resources/photo-88.jpg" />"
										title="" data-strip-group="mygroup"
										data-strip-group-options="loop: false"> <img
										src="<c:url value="/layouts/web/images/resources/photo8.jpg" />"
										alt=""></a>
									<div class="over-photo">
										<div class="likes heart" title="Like/Dislike">
											❤ <span>87</span>
					...
					<div class="central-meta">
						<span class="create-post">Videos (33) <a
							href="timeline-videos" title="">See All</a></span>
							...
							<li>
								<div class="item-box">
									<a href="https://www.youtube.com/watch?v=fF382gwEnG8&amp;t=1s"
										...
										src="<c:url value="/layouts/web/images/resources/vid-11.jpg" />"
							...
							<li>
								<div class="item-box">
									<a href="https://www.youtube.com/watch?v=fF382gwEnG8&amp;t=1s"
										title="" data-strip-group="mygroup" class="strip"
										data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
										src="<c:url value="/layouts/web/images/resources/vid-12.jpg" />"
										alt=""> <i> <svg version="1.1" class="play"
												xmlns="http://www.w3.org/2000/svg"
												xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												height="50px" width="50px" viewBox="0 0 100 100"
							...
							<li>
								<div class="item-box">
									<a href="https://www.youtube.com/watch?v=fF382gwEnG8&amp;t=1s"
										title="" data-strip-group="mygroup" class="strip"
										data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
										src="<c:url value="/layouts/web/images/resources/vid-10.jpg" />"
										alt=""> <i> <svg version="1.1" class="play"
												xmlns="http://www.w3.org/2000/svg"
												xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												height="50px" width="50px" viewBox="0 0 100 100"
							...
							<li>
								<div class="item-box">
									<a href="https://www.youtube.com/watch?v=fF382gwEnG8&amp;t=1s"
										title="" data-strip-group="mygroup" class="strip"
										data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
										src="<c:url value="/layouts/web/images/resources/vid-9.jpg" />"
										alt=""> <i> <svg version="1.1" class="play"
												xmlns="http://www.w3.org/2000/svg"
												xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												height="50px" width="50px" viewBox="0 0 100 100"
							...
							<li>
								<div class="item-box">
									<a href="https://www.youtube.com/watch?v=fF382gwEnG8&amp;t=1s"
										title="" data-strip-group="mygroup" class="strip"
										data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
										src="<c:url value="/layouts/web/images/resources/vid-6.jpg" />"
										alt=""> <i> <svg version="1.1" class="play"
												xmlns="http://www.w3.org/2000/svg"
												xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												height="50px" width="50px" viewBox="0 0 100 100"
