					...
					<aside class="sidebar static">
						<div class="widget">
							<h4 class="widget-title">
								Explor Events <a class="see-all" href="#" title="">See All</a>
							</h4>
							<div class="rec-events bg-purple">
								<i class="ti-gift"></i>
								<h6>
									<a title="" href="#">Ocean Motel good night event in
										columbia</a>
								</h6>
							...
							<div class="rec-events bg-blue">
								...
								<h6>
									<a title="" href="#">2016 The 3rd International Conference</a>
								</h6>
								<img alt="" src="images/clock.png">
							</div>
						</div>
							...
							<div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
								<div class="item-box">
									<a href="https://www.youtube.com/watch?v=PDluztBSaBc" title=""
										...
										src="images/resources/vid-1.jpg" alt=""> <i> <svg
												version="1.1" class="play"
							...
							<div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
								<div class="item-box">
									<a href="https://www.youtube.com/watch?v=PDluztBSaBc" title=""
										data-strip-group="mygroup" class="strip"
										data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
										src="images/resources/vid-2.jpg" alt=""> <i> <svg
												version="1.1" class="play"
												xmlns="http://www.w3.org/2000/svg"
												xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												height="50px" width="50px" viewBox="0 0 100 100"
							...
							<div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
								<div class="item-box">
									<a href="https://www.youtube.com/watch?v=PDluztBSaBc" title=""
										data-strip-group="mygroup" class="strip"
										data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
										src="images/resources/vid-3.jpg" alt=""> <i> <svg
												version="1.1" class="play"
												xmlns="http://www.w3.org/2000/svg"
												xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												height="50px" width="50px" viewBox="0 0 100 100"
							...
							<div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
								<div class="item-box">
									<a href="https://www.youtube.com/watch?v=PDluztBSaBc" title=""
										data-strip-group="mygroup" class="strip"
										data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
										src="images/resources/vid-4.jpg" alt=""> <i> <svg
												version="1.1" class="play"
												xmlns="http://www.w3.org/2000/svg"
												xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												height="50px" width="50px" viewBox="0 0 100 100"
							...
							<div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
								<div class="item-box">
									<a href="https://www.youtube.com/watch?v=PDluztBSaBc" title=""
										data-strip-group="mygroup" class="strip"
										data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
										src="images/resources/vid-5.jpg" alt=""> <i> <svg
												version="1.1" class="play"
												xmlns="http://www.w3.org/2000/svg"
												xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												height="50px" width="50px" viewBox="0 0 100 100"
							...
							<div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
								<div class="item-box">
									<a href="https://www.youtube.com/watch?v=PDluztBSaBc" title=""
										data-strip-group="mygroup" class="strip"
										data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
										src="images/resources/vid-6.jpg" alt=""> <i> <svg
												version="1.1" class="play"
												xmlns="http://www.w3.org/2000/svg"
												xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												height="50px" width="50px" viewBox="0 0 100 100"
							...
							<div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
								<div class="item-box">
									<a href="https://www.youtube.com/watch?v=PDluztBSaBc" title=""
										data-strip-group="mygroup" class="strip"
										data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
										src="images/resources/vid-7.jpg" alt=""> <i> <svg
												version="1.1" class="play"
												xmlns="http://www.w3.org/2000/svg"
												xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												height="50px" width="50px" viewBox="0 0 100 100"
							...
							<div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
								<div class="item-box">
									<a href="https://www.youtube.com/watch?v=PDluztBSaBc" title=""
										data-strip-group="mygroup" class="strip"
										data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
										src="images/resources/vid-8.jpg" alt=""> <i> <svg
												version="1.1" class="play"
												xmlns="http://www.w3.org/2000/svg"
												xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												height="50px" width="50px" viewBox="0 0 100 100"
							...
							<div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
								<div class="item-box">
									<a href="https://www.youtube.com/watch?v=PDluztBSaBc" title=""
										data-strip-group="mygroup" class="strip"
										data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
										src="images/resources/vid-9.jpg" alt=""> <i> <svg
												version="1.1" class="play"
												xmlns="http://www.w3.org/2000/svg"
												xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												height="50px" width="50px" viewBox="0 0 100 100"
							...
							<div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
								<div class="item-box">
									<a href="https://www.youtube.com/watch?v=PDluztBSaBc" title=""
										data-strip-group="mygroup" class="strip"
										data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
										src="images/resources/vid-10.jpg" alt=""> <i> <svg
												version="1.1" class="play"
												xmlns="http://www.w3.org/2000/svg"
												xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												height="50px" width="50px" viewBox="0 0 100 100"
							...
							<div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
								<div class="item-box">
									<a href="https://www.youtube.com/watch?v=PDluztBSaBc" title=""
										data-strip-group="mygroup" class="strip"
										data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
										src="images/resources/vid-11.jpg" alt=""> <i> <svg
												version="1.1" class="play"
												xmlns="http://www.w3.org/2000/svg"
												xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												height="50px" width="50px" viewBox="0 0 100 100"
							...
							<div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
								<div class="item-box">
									<a href="https://www.youtube.com/watch?v=PDluztBSaBc" title=""
										data-strip-group="mygroup" class="strip"
										data-strip-options="width: 700,height: 450,youtube: { autoplay: 1 }"><img
										src="images/resources/vid-12.jpg" alt=""> <i> <svg
												version="1.1" class="play"
												xmlns="http://www.w3.org/2000/svg"
												xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												height="50px" width="50px" viewBox="0 0 100 100"
